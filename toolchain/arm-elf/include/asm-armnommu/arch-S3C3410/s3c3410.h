/*
 * uclinux/include/asm-armnommu/arch-S3C3410/s3c3410.h
 *
...
#define S3C3410X_SYSCFG_CEN	0x00000002		/* CPU-internal cache enable */
...
#define UFCON_TFTL_2		0x00	/* UART Transmit FIFO Trigger Level: 2 byte */
#define UFCON_TFTL_4		0x10	/* UART Transmit FIFO Trigger Level: 4 byte */
#define UFCON_TFTL_6		0x20	/* UART Transmit FIFO Trigger Level: 6 byte */
#define UFCON_TFTL_8		0x30	/* UART Transmit FIFO Trigger Level: 8 byte */

#define UFSTAT_RFF		0x20	/* UART FIFO STATUS Receive FIFO FULL */
#define UFSTAT_RFF		0x20	/* UART FIFO STATUS Transmit FIFO FULL */
#define UFSTAT_RFF		0x20	/* UART FIFO STATUS Receive FIFO FULL */
