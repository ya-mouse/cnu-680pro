 ...
 *
 *	$Id: br_fdb.c,v 1.2 2003/12/24 07:28:56 odorong Exp $
 *
...
extern void expire_fdb_in_br2684(struct net_bridge_fdb_entry *fdb, int delif);
extern void add_new_fdb_in_br2684(struct net_bridge_fdb_entry *fdb);
#endif
