...
typedef	struct	{
	...
	UINT		ppp_mru;
	UINT		ppp_mtu;	
	UINT		ppp_lcp_echo_interval;		// cecece (03.04.07)
	UINT		ppp_lcp_echo_failure;		// cecece (03.04.07)
}	ADSL_ENV, *PADSL_ENV;
...
#define	FD_ENCAP				"RFC1483br"			//	Encapsulation mode (Should be one of these! - Case sensitive)
												//				(String:		"RFC1483br"
												//							"RFC1483rt"
												//							"PPPOE"
												//							"PPPOA"		)
...
#define	FD_MANAGE_ID				"root"			//	User ID					(String)
#define	FD_MANAGE_PW			"root"			//	User password				(String)
//
//////////////////////////////////////////////////
...
#define	FD_DHCP_INTERFACE		"sbridge"			//	DHCP server default interface	(String)
...
#define	FD_PPP_LCP_ECHO_INTERVAL 			60			// PPP lcp echo interval options	(Integer: If 0, it'll be ignored) cecece (03.04.07)
#define	FD_PPP_LCP_ECHO_FAILURE			     3			//	PPP lcp echo failure options	(Integer: If 0, it'll be ignored) cecece (03.04.07)
//
//////////////////////////////////////////////////
