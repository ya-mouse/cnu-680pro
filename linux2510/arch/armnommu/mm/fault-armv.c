...
bad:
	...
	//choish_shared_lib_porting. for dubugging
	printk(KERN_ALERT "Unhandled fault: %s (%X) at 0x%08lx (pc=0x%x,sp=0x%x,lr=0x%x)\n",
		inf->name, fsr, addr, regs->ARM_pc, regs->ARM_sp, regs->ARM_lr);
