...
// Radicalis_hans_begin (03.12.18) - dma access is possible, so make it GFP_DMA
#ifdef	CONFIG_UNCACHED_MEM
	gfp |= GFP_DMA;
#endif
// Radicalis_hans_end (03.12.18)
...
#endif
// Radicalis_hans_begin (03.12.18) - delete #ifdef, #endif
///* ryc++ must allocate at non-cache region */
