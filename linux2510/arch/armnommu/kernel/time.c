...
static void setup_init_button(void);	// KenC, 20031105, coreyliu 20040202 ported
...
//< KenC, 20031105 coreyliu 20040202 ported
static void setup_init_button(void)
{
    unsigned long tmp;

    /* I/O port is used for init button */
    tmp = *(unsigned int *)IOPMOD1;
    tmp |= 0x00000020;	// GPIO5 as input mode
    *(unsigned int *)IOPMOD1 = tmp;
}
...
void __init time_init(void)
{
	...
	setup_timer();
	setup_init_button();	/* KenC, 2031105, coreyliu 20040202 ported */
