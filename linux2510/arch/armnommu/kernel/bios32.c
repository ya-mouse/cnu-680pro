/*
 *  linux/arch/armnommu/kernel/bios32.c
 *
 *  PCI bios-type initialisation for PCI machines
 *
 *  Bits taken from various places.
 *  History :
 *  2003-05-20 : code added for S3C2510 by Roh you-chang(terius90@samsung.com)
 */
...
/* ryc++ : defined hw_pci for smdk2510.
 *         ryc defined this structure 
 *         at uClinux-dist-2510/linux-2.4.x/arch/armnommu/mach-SMDK2510/smdk2510-pci.c
 */ 
extern struct hw_pci smdk2510_pci; 
...
void __init pcibios_init(void)
{
	...
	do {
#if CONFIG_BOARD_SMDK2510       
		printk("board detection: SMDK2510\n");
        if (machine_is_smdk2510()) {
#elif CONFIG_BOARD_2510REF
		printk("board detection: 2510REF board\n");
        if (machine_is_2510ref()) {
#endif
            hw = &smdk2510_pci;
            break;
        }
     ...
     *
     *   ryc :
     *          setup_resources function defined at smdk2510-pci.c
     *          init function defined at smdk2510-pci.c
     *          iomem_pci_resource is only for pci addresses.
     */
...
//		root->resource[1] = &iomem_pci_resource;
 ...
 */
/* ryc-- compilation error 
int pcibios_enable_device(struct pci_dev *dev)
*/
int pcibios_enable_device(struct pci_dev *dev, int mask) //ryc++ for compilation
{
	u16 cmd, old_cmd;
	int idx;
	struct resource *r;
