...
#if !defined(__alpha__) && !defined(__sparc__) && !defined(__ia64__) && !defined(CONFIG_ARCH_S390) && !defined(__hppa__) && !defined(__x86_64__) && !defined(__arm__) && !defined(CONFIG_V850) && !defined(CONFIG_MICROBLAZE)
