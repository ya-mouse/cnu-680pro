...
// choish_shared_lib_porting, add header file for cramfs support
#include <linux/cramfs_fs_i.h>
...
struct inode {
	...
	union {
		...
		struct cramfs_inode_info    cramfs_i; // choish_shared_lib_porting, add struct for cramfs
...
#endif /* MAGIC_ROM_PTR */
// choish_shared_lib_porting, memory manage
#ifdef CONFIG_MMAP_FIX
	int (*munmap) (struct inode *);
