 ...
 *
 * history:
 * 	2003.05.23 inserted code in relation with pci by
...
#define DCON(channel)       (VPint(DCON0 + channel*0x20))   //  GDMA channel con
#define DSAR(channel)       (VPint(DSAR0 + channel*0x20))   //  GDMA channel sou
#define DDAR(channel)       (VPint(DDAR0 + channel*0x20))   //  GDMA channel des
#define DTCR(channel)       (VPint(DTCR0 + channel*0x20))   //  GDMA channel tra
#define DRER(channel)       (VPint(DRER0 + channel*0x20))   //  GDMA channel run
#define DIPR(channel)       (VPint(DIPR0 + channel*0x20))   //  GDMA channel int
#endif 
