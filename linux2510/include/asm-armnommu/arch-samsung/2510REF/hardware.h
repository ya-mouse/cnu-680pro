 ...
 * based on the Samsung's "S3C2510 32-bit RISC
 * microcontroller pre. User's Manual"
 *
 * history:
 * 	2003.05.24: included pcibios_def.h by Roh you-chang(terius90@samsung.com)
 */
...
#define VA_USB_BASE     0xF0100000      /* 20040202 added by coreyliu for USB to work */
/*
---	HDLC controller
*/
...
*/
#ifdef CONFIG_PCI
#include <asm/arch/pcibios_def.h>
#else
#endif
