...
/*
 * ./include/asm-armnommu/arch-samsung/2510REF/pci.h
 *   pci header file  for 2510REF
...
typedef struct {
	...
	unsigned int	PCIINT:1;		// Bit 31 (INT) : Internal Interrupt Signaled	
}s_PCICON;
...
typedef struct {		//-.-\\ Function(agent)
	...
	unsigned int	PCIINT:1;		// Bit 15 (INT) : Function Event Interrupt Event
...
typedef struct {		//-.-\\ Function(agent)
	...
	unsigned int	PCIINT:1;		// Bit 15 (INT) : Function Event Interrupt Mask
	unsigned int	rs2:16;		// 31 -16 (rs2)
}f_PCCARDEVM;
...
typedef struct {		//-.-\\ Function(agent)
	...
	unsigned int	PCIINT:1;		// Bit 15 (INT) : Function Event Status
...
typedef struct {		//-.-\\ Function(agent)
	...
	unsigned int	rs1:10;		// 14 - 5 (rs1)
	unsigned int	PCIINT:1;		// Bit 15 (INT) : Force Function Event Interrupt
	unsigned int	rs2:16;		// 31 -16 (rs2)
}f_PCCARDFEV;
