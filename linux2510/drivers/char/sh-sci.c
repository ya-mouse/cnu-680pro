/* $Id: sh-sci.c,v 1.1.1.1 2003/11/17 02:33:42 jipark Exp $
 *
...
static void sci_init_pins_h8300(struct sci_port* port, unsigned int cflag);
#endif
...
#if defined(CONFIG_CPU_SUBTYPE_SH7750) || defined (CONFIG_CPU_SUBTYPE_SH7751) || defined(CONFIG_CPU_SUBTYPE_ST40STB1)
