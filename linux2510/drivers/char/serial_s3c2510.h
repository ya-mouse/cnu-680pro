/*
 * drivers/char/serial-s3c2510.h
 * 
 * Serial port driver for the Samsung S3C2510X builtin UARTs
 *
 * Copyright (C) 2002  Oleksandr Zhadan <oleks@arcturusnetworks.com>
 *
 * Based on: drivers/char/serial-s3c4530.h
 * Copyright (C) 2001,2002  Oleksandr Zhadan <oleks@arcturusnetworks.com>
 *
...
#ifndef _s3c2510_SERIAL_H
#define _s3c2510_SERIAL_H
...
struct s3c2510_serial {
	...
	int			type; 		/* UART type */
	int			use_ints;
	volatile struct s3c2510_usart_regs	*usart;
	int			cts_state;
