...
#ifdef CONFIG_SITECTRLER
	/* This board with a specific USB modem has problems honouring the
	 * USB specification.  Fudge the fminterval setting to compensate.
	 */
	fminterval |= (2048 << 16); 
#else
	fminterval |= ((((fminterval - 1024) * 6) / 7) << 16); 
#endif
#else
...
//static int __devinit    //20040128 by Corey
int __devinit
