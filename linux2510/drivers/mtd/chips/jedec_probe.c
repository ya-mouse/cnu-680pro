/* 
   ...
   $Id: jedec_probe.c,v 1.1.1.1 2003/11/17 02:34:01 jipark Exp $
*/
...
#define AM29LV320DB	0x22F9  /*Frank, 20Mar2003 : Added new type flash */ 
/* Atmel */
...
static const struct amd_flash_info jedec_table[] = {
	{		
		...
		mfr_id: MANUFACTURER_SST,  /* Frank, 20Mar2003 : Added new type flash */
		dev_id: SST39VF160,
		name: "SST SST39VF160",
		DevSize: SIZE_2MiB,
		NumEraseRegions: 1,
		regions: {ERASEINFO(0x00800,1024)
		}	
	}, {
		mfr_id: MANUFACTURER_SST,  /* Frank, 20Mar2003 : Added new type flash */
		dev_id: SST39VF1601,
		name: "SST SST39VF1601",
		DevSize: SIZE_2MiB,
		NumEraseRegions: 1,
		regions: {ERASEINFO(0x00800,1024)
		}	
	}, {
	        mfr_id: MANUFACTURER_SST,  /*Storm, 2004.03.03 : Added new type flash */
	        dev_id: SST39VF3201,
	        name: "SST SST39VF3201",
	        DevSize: SIZE_4MiB,
	        NumEraseRegions: 1,
	        regions: {ERASEINFO(0x00800,2048)
	        }
	}, {
	        mfr_id: MANUFACTURER_AMD,  /*Frank, 20Mar2003 : Added new type flash */
	        dev_id: AM29LV320DB,
