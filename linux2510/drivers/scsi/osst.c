/*
  ...
  $Header: /opt/CVS/Radicalis/uClinux-dist/linux-2.4.x/drivers/scsi/osst.c,v 1.1.1.1 2003/11/17 02:34:40 jipark Exp $
...
static const char * cvsid = "$Id: osst.c,v 1.1.1.1 2003/11/17 02:34:40 jipark Exp $";
