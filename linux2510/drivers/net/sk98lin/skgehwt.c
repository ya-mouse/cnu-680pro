 ...
 *
 *	$Log: skgehwt.c,v $
 *	Revision 1.1.1.1  2003/11/17 02:34:18  jipark
...
static const char SysKonnectFileId[] =
	"$Header: /opt/CVS/Radicalis/uClinux-dist/linux-2.4.x/drivers/net/sk98lin/skgehwt.c,v 1.1.1.1 2003/11/17 02:34:18 jipark Exp $" ;
