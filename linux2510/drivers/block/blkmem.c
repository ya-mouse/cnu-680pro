...
#include <linux/devfs_fs_kernel.h> //coreyliu from uc1
 ...
 */
#if defined(CONFIG_BOARD_SMDK2510) | defined(CONFIG_BOARD_2510REF)        // 20030321 added by drsohn for compressed romfs
...
#if defined(CONFIG_ARCH_DSC21) || defined(CONFIG_ARCH_ATMEL) || defined(CONFIG_BOARD_SNDS100)
...
// choish_shared_lib_porting, for CRAMFS support
#ifdef CONFIG_ROOTFS_ROMFS
	{0, romfs_data, -1},
#endif
#ifdef CONFIG_ROOTFS_CRAMFS
	{0, CONFIG_CRAMFS_BASE, -1},
#endif
#endif
...
static devfs_handle_t devfs_handle; // coreyliu 20040210 add from uc1
...
#if defined(CONFIG_FLASH_SNAPGEAR) || defined(CONFIG_CLEOPATRA) || defined(CONFIG_M5272C3)
...
#endif
#if !defined(MODULE)
#if !defined(CONFIG_COLDFIRE) && !defined(CONFIG_M68328) && !defined(CONFIG_EXCALIBUR)
