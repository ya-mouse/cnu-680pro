...
check_gcc=$(shell if $(CC) $(1) -nostdinc -S -o /dev/null -xc /dev/null > /dev/null 2>&1; \
...
#	OPTIMIZATION+=-fstrict-aliasing
	...
	CPU_CFLAGS-$(CONFIG_ARM7TDMI):="-mcpu=arm7tdmi -mtune=arm7tdmi"
